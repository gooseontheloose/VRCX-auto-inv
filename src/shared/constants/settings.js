...
const branches = {
    Stable: {
        name: 'Stable',
        urlReleases: 'https://api.github.com/repos/gooseontheloose/VRCX-auto-inv/releases',
        urlLatest: 'https://api.github.com/repos/gooseontheloose/VRCX-auto-inv/releases/latest'
    },
    Nightly: {
        name: 'Nightly',
        urlReleases: 'https://api.github.com/repos/gooseontheloose/VRCX-auto-inv/releases',
