    ...
    public static class Program
    {
        ...
        private static void GetVersion()
        {
            try
            {
                ...
                if (version.Length > 0 && version[^1].Length == 7)
                    Version = $"PAW Inviter - VRCX Nightly {versionFile}";
                else
                    Version = $"PAW Inviter - VRCX {versionFile}";
            }
            catch (Exception ex)
            {
                logger.Error(ex, "Failed to read version file");
                Version = "PAW Inviter - VRCX Nightly Build";
            }
        }
        ...
        private static void Main()
        {
            ...
            catch (SQLiteException e)
            {
                ...
                {
                    AppApiInstance.OpenLink("https://github.com/gooseontheloose/VRCX-auto-inv/wiki#how-to-repair-vrcx-database");
                }
            }
